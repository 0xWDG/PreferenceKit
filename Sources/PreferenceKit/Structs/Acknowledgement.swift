...
/// An acknowledgement entry for display in `AcknowledgementView`.
///
/// Acknowledgement entry for use in the `AcknowledgementView`.
public struct Acknowledgement: Identifiable, Hashable {
